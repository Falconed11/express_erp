...
import coaRoleVisibilityRoutes from "./src/modules/coa/coa-role-visibility.route.js";
...
import jurnalFormRoutes from "./src/modules/akuntansi/jurnal-form.route.js";
import jurnalExpressionRoutes from "./src/modules/akuntansi/jurnal-expression.route.js";
import jurnalFormExpressionRoutes from "./src/modules/akuntansi/jurnal-form-expression.route.js";
import keranjangProyekRoutes from "./src/routes/keranjang-proyek.routes.js";
import laporanRelationRoutes from "./src/modules/akuntansi/laporan-relation.route.js";
...
app.use("/api/v2/coa-role-visibility", coaRoleVisibilityRoutes);
...
app.use("/api/v2/jurnal", jurnalRoutes);
app.use("/api/v2/jurnal-form", jurnalFormRoutes);
app.use("/api/v2/jurnal-expression", jurnalExpressionRoutes);
app.use("/api/v2/jurnal-form-expression", jurnalFormExpressionRoutes);
app.use("/api/v2/keranjang-proyek", keranjangProyekRoutes);
app.use("/api/v2/laporan", laporanRoutes);
